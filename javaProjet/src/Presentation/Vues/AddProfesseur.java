...
public class AddProfesseur extends JFrame
{
	private JPanel p1;
	private JPanel p2;
	private JPanel p3;
	...
	public AddProfesseur(ControlleurProfesseurAdd controlleur, ModelProfesseurProfesseur model, Professeur p)
	...
	public void initialiser()
	{
		...
		text = new JLabel("Inserer les information du professeur");
	...
	public void dessiner()
	{
		...
		controlleur = new ControlleurProfesseurAdd();
		controlleur.setF2(this);
	}
	...
	public void action()
	{
		...
		valider.addActionListener(new ActionListener() {
			...
			p = new Professeur(textFieldCode.getText(),textFieldNom.getText(),textFieldPrenom.getText(),
			 ...
			 controlleur.executeProfesseurAdminstration();
	...
	public static void main(String[] args) {
		AddProfesseur a = new AddProfesseur();
		a.setVisible(true);
	}
